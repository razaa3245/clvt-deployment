<footer class="border-t border-gray-200 bg-white text-gray-700 mt-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-8 py-10 flex flex-col md:flex-row md:justify-between items-center md:items-start">
    <!-- Left Section -->
    <div class="flex flex-col items-center text-center space-y-4 mb-8 md:mb-0 md:w-1/3 md:items-start md:text-left">
      ...
      <!-- Language Selector -->
      <div class="flex items-center border rounded-lg px-3 py-2 w-fit text-sm cursor-pointer hover:bg-gray-50 justify-center md:justify-start">
