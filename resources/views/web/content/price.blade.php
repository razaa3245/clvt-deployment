...
<body class="bg-gradient-to-br from-slate-50 via-white to-slate-100 font-sans antialiased">
  ...
  <!-- Hero Header Section (dark bg — navbar will auto-switch to white text on scroll) -->
  <div class="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-cyan-600 py-20 px-4 pt-36">
    <!-- Decorative Elements -->
            ...
            <div class="space-y-4">
              <div class="flex items-start gap-3">
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-cyan-400/30 backdrop-blur-sm flex items-center justify-center mt-0.5">
                  <svg class="w-4 h-4 text-cyan-100" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                </div>
  ...
  <div class="relative py-24 px-4 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto">
      <div class="text-center mb-16">
        ...
        <h2 class="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">All Plans Include</h2>
        <p class="text-xl text-gray-600 max-w-2xl mx-auto">Every plan comes with our complete suite of powerful features to transform your optical business</p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="group relative bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">Virtual Try-On Technology</h3>
          <p class="text-gray-600 text-sm leading-relaxed">Advanced AR-powered virtual try-on for realistic lens previews that help customers visualize their perfect look</p>
        ...
        <div class="group relative bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-purple-600 transition-colors duration-300">QR Code Generation</h3>
          <p class="text-gray-600 text-sm leading-relaxed">Instant QR code generation for seamless customer access via mobile devices, making try-ons effortless</p>
        ...
        <div class="group relative bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-orange-600 transition-colors duration-300">Shop Dashboard</h3>
          <p class="text-gray-600 text-sm leading-relaxed">Comprehensive dashboard to manage your entire optical shop operations from a single, intuitive interface</p>
        ...
        <div class="group relative bg-white rounded-2xl p-8 shadow-lg border border-gray-200 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
          ...
          <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-green-600 transition-colors duration-300">Regular Updates</h3>
          <p class="text-gray-600 text-sm leading-relaxed">Continuous platform improvements and new features to keep your shop at the cutting edge of technology</p>
      ...
      <div class="mt-16 text-center">
        <h3 class="text-3xl font-bold text-gray-900 mb-4">Ready to Transform Your Optical Shop?</h3>
        <p class="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">Join hundreds of optical shops already using VisionTech to enhance customer experience</p>
