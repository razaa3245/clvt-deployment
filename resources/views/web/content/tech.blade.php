<section id="technology" class="py-20 bg-gray-50 font-sans">
  <div class="max-w-6xl mx-auto flex flex-wrap items-center justify-between gap-10">
    <!-- Image Side -->
    ...
    <!-- Content Side -->
    <div class="flex-1 min-w-[320px] text-gray-900 leading-relaxed z-10">
      ...
      <div>
        <div class="flex items-center mb-2">
          ...
          <span>Real-time face tracking and alignment</span>
        </div>
        <div class="flex items-center mb-2">
          <svg class="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span>Accurate size and fit recommendations</span>
        </div>
        <div class="flex items-center mb-2">
          <svg class="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span>Multi-angle view support</span>
        </div>
        <div class="flex items-center mb-2">
          <svg class="w-5 h-5 mr-2 text-blue-600" fill="none" stroke="currentColor" stroke-width="2"
            viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
          ...
          <span>Color and style customization</span>
        </div>
        <div class="flex items-center">
          ...
          <span>Contact lens overlay technology</span>
        </div>
      </div>
      <!-- Info Card -->
      <div class="bg-sky-400 text-white px-6 py-5 rounded-xl mt-8 flex items-center">
        <div class="text-2xl font-bold mr-4">99.9%</div>
...
<section class="py-24 bg-gradient-to-br from-blue-600 to-blue-900 text-white font-sans">
  <div class="max-w-3xl mx-auto text-center">
    <h2 class="text-2xl font-bold mb-4">Ready to Transform Your Eyewear Business?</h2>
    <p class="text-base mb-8">Join leading brands already using our virtual try-on technology. Start your free trial today and see the difference.</p>
    ...
    <p class="text-sm mt-5 opacity-90">No credit card required · 14-day free trial · Cancel anytime</p>
  </div>
</section>
