    ...
    <div class="left-panel">
      ...
      <div class="right-panel">
        <div class="form-header">
          ...
          <p class="form-subtitle">Enter your new password to complete the reset process.</p>
        </div>

        <form method="POST" action="{{ route('password.reset.verified') }}">
          @csrf

          <div class="form-group">
            <label for="password" class="form-label">New Password</label>
            <input id="password" name="password" type="password" autocomplete="new-password" required class="form-input" placeholder="New Password">
          </div>

          <div class="form-group">
            <label for="password_confirmation" class="form-label">Confirm New Password</label>
            <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" required class="form-input" placeholder="Confirm New Password">
          </div>
